...
Example: +
====
Input: [blue]`repeat r/3 i/7 n/Lecture p/3 t/CS3241 d/101018 v/mpsh1`
...
(The task is set three times at a interval of 7 days.)
====
...
[WARNING]
All the fields except tag are optional.
